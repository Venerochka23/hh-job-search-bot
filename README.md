# hh-job-search-bot
Бот в телеграм для автоматизации поиска вакансий на hh.ru: находит вакансии по заданным фильтрам, отправляет вакансии в чат ("Откликнуться"/"Пропустить"), ИИ генерирует сопроводительное письмо по заранее переданному шаблону для тех вакансий, на которые вы решаете откликнуться. Предложения: @darkendless 
